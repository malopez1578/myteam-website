...
function $a(e) {
	...
	n !== null && ((e.alternate = null), $a(n)),
		...
		e.tag === 5 &&
			((n = e.stateNode),
			n !== null &&
				(delete n[Fe], delete n[At], delete n[go], delete n[Xf], delete n[Gf])),
		(e.stateNode = null),
		(e.return = null),
		(e.dependencies = null),
			...
			switch (((e.finishedWork = l), (e.finishedLanes = r), n)) {
				...
				case 3:
					if (
						...
						e.timeoutHandle = yo(wn.bind(null, e, se, $e), n);
						break;
					}
					wn(e, se, $e);
					break;
				case 4:
					...
					if (
						...
						e.timeoutHandle = yo(wn.bind(null, e, se, $e), r);
						break;
					}
					wn(e, se, $e);
					break;
	...
	switch (e.tag) {
		case 3:
			...
			if (n.current.memoizedState.isDehydrated) {
				...
				t !== 0 &&
					(Jo(n, t | 1), de(n, W()), !(R & 6) && ((rt = W() + 500), vn()));
			}
			break;
		case 13:
			Ln(function () {
			...
			De.jsxs('div', {
				...
				children: [
					...
					De.jsxs('p', {
						children: [
							'Edit ',
							De.jsx('code', { children: 'src/App.tsx' }),
...
Ql.createRoot(document.getElementById('root')).render(
	De.jsx(wc.StrictMode, { children: De.jsx(Rd, {}) })
);
